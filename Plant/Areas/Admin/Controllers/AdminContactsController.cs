...
namespace Plant.Areas.Admin.Controllers
{
    ...
    public class AdminContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Name,Phone,Email,Title,Description")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactId,Name,Phone,Email,Title,Description")] Contact contact)
        {
